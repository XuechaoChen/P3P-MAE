...
class Point_MAE(nn.Module):
    ...
    def build_loss_func(self, loss_type):
        self.loss_func = chamfer_loss

    def forward(self, pts, vis = False, **kwargs):
        neighborhood, center = self.group_divider(pts[1]['pts'])
        ...
        loss1 = self.loss_func(rebuild_points, gt_points, reduce='mean')
...
class PointTransformer(nn.Module):
    ...
    def load_from_ckpts(self, bert_ckpt_path):
